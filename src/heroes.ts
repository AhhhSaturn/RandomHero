...
export const heroes = {
	support: [
		...
		{ name: "Jetpack Cat", file: "Jpc.png", color: "#aab3c0" },
		...
		{ name: "Mizuki", file: "Mizuki.png", color: "#9affc7" },
		{ name: "Moira", file: "Moira.png", color: "#9771e4" },
		{ name: "Zenyatta", file: "Zenyatta.png", color: "#ece580" },
		{ name: "Wuyang", file: "Wuyang.png", color: "#436fd2" },
	],
	tank: [
		{ name: "D.Va", file: "D.Va.png", color: "#ed93c7" },
		{ name: "Domina", file: "Domina.png", color: "#69deef" },
	...
	dps: [
		{ name: "Anran", file: "Anran.png", color: "#e81a05" },
		...
		{ name: "Emre", file: "Emre.png", color: "#c70c0c" },
		...
		{ name: "Vendetta", file: "Vendetta.png", color: "#83191e" },
